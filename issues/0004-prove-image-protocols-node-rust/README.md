...
path, but full-color Plotly screenshots would require quantization or a
maintained encoder; OSC 1337 remains the simpler iTerm2 default while Kitty
remains the Ghostty default.
